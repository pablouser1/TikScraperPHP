...
(function () {
    utils.init();
    let fns = {
        generateMimeTypeArray: (fns) => mimeTypesData => {
            return fns.generateMagicArray(fns)(
                mimeTypesData,
        ...
        generatePluginArray: (fns) => pluginsData => {
            return fns.generateMagicArray(fns)(
                pluginsData,
    ...
    const mimeTypes = fns.generateMimeTypeArray(fns)(data.mimeTypes)
    const plugins = fns.generatePluginArray(fns)(data.plugins)
